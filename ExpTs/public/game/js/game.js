...
const phases = [
  {
    background: '/game/assets/images/background_fase1.png',
    music: 0,
    obstacles: [
      { type: 'stake',  x: 500  },
      { type: 'garlic', x: 1000 },
  ...
  {
    background: '/game/assets/images/background_fase2.png',
    music: 1,
    obstacles: [
      { type: 'garlic', x: 500  },
      { type: 'stake',  x: 1000 },
  ...
  {
    background: '/game/assets/images/background_fase3.png',
    music: 2,
    obstacles: [
      { type: 'garlic', x: 500  },
      { type: 'fool',   x: 900  },
...
/* =====================
   GAME OVER — envia score ao servidor via Ajax (#16)
   ===================== */
function triggerGameOver() {
  ...
  // Envia o score ao servidor para salvar na tabela game_sessions
  fetch('/game-session', {
    method: 'POST',
  ...
  marci.style.backgroundImage = "url('/game/assets/images/marci-gameover.png')";
}
...
function showInstructions() { showScreen('screen-instructions'); }
